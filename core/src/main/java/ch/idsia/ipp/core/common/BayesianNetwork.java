package ch.idsia.ipp.core.common;
        ...
        import ch.idsia.ipp.core.common.tw.TreeWidth;
        ...
        import ch.idsia.ipp.core.utils.exp.CyclicGraphException;
        import ch.idsia.ipp.core.utils.exp.TreeWidthExceededException;
...
public class BayesianNetwork implements Serializable {
    ...
    /**
     * Find out if the structure is equivalent of the dand network.
     *
     * @param bn_q the dand network
     * @return if the structure of the network (number of nodes, parents for each node) is equivalent.
     */
