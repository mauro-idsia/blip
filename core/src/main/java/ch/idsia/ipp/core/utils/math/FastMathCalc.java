package ch.idsia.ipp.core.utils.math;
...
class FastMathCalc {
     ...
     *  for extra precision (thread.e. exp(x) = result[0] + result[1]
     *  @return exp(x)
     */
     ...
     */
    static void printarray(PrintStream out, String name, int expectedLen, double[][] array2d) throws Exception {
        out.println(name);
     ...
     */
    static void printarray(PrintStream out, String name, int expectedLen, double[] array) throws Exception {
        out.println(name + "=");
     ...
     * @exception Exception if the two lengths are not equal
     */
