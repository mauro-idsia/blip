...
import ch.idsia.ipp.core.common.math.ChiSquare;
...
public class MutualInformation extends Oracle {
    ...
    public MutualInformation(DataFileReader dat) {
        this(dat, 0.05, 1);
    }

    public MutualInformation(DataFileReader dat, double alpha, int maxDF) {
        super(dat);
        this.alpha = alpha;
