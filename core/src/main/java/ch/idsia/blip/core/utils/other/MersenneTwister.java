...
public class MersenneTwister {
    ...
    protected void nextBlock() {
        ...
        for (var2 = 0; var2 < 227; ++var2) {
            ...
            this.mt[var2] = this.mt[var2 + 397] ^ var1 >>> 1 ^ ((var1 & 1) == 0 ? 0 : -1727483681);
        }

        while (var2 < 623) {
            var1 = this.mt[var2] & -2147483648 | this.mt[var2 + 1] & 2147483647;
            this.mt[var2] = this.mt[var2 + -227] ^ var1 >>> 1 ^ ((var1 & 1) == 0 ? 0 : -1727483681);
            ++var2;
        }

        var1 = this.mt[623] & -2147483648 | this.mt[0] & 2147483647;
        this.mt[623] = this.mt[396] ^ var1 >>> 1 ^ ((var1 & 1) == 0 ? 0 : -1727483681);
        this.mti = 0;
    }
    ...
    protected void setSeed(int var1) {
        ...
        for (int var2 = 1; var2 < 624; ++var2) {
            this.mt[var2] = 1812433253 * (this.mt[var2 - 1] ^ this.mt[var2 - 1] >> 30) + var2;
            this.mt[var2] &= -1;
        }
